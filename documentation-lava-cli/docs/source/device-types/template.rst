...
``lava device-types template get``
----------------------------------
...
.. code-block:: text
   ...
   lava device-types template get <name>
...
.. code-block:: bash
   ...
   lava device-types template get qemu > qemu.jinja2

If the device type has no configuration revisions, the command reports an
error.

``lava device-types template set``
----------------------------------
...
.. code-block:: text
   ...
   lava device-types template set <name> <file> [flags]
...
.. code-block:: bash
   ...
   lava device-types template set qemu qemu.jinja2 -m "Bump kernel args"

   # Read from stdin
   cat qemu.jinja2 | lava device-types template set qemu - -m "Piped update"
